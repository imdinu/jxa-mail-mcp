...
from jxa_mail_mcp.index.manager import IndexManager, IndexStats
...
class TestSyncUpdates:
    ...
    @patch("jxa_mail_mcp.index.sync.sync_from_disk")
    @patch("jxa_mail_mcp.index.disk.find_mail_directory")
...
class TestSearch:
    ...
    @patch("jxa_mail_mcp.index.search.search_fts")

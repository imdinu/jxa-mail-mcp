...
class TestListAccounts:
    ...
    @pytest.mark.asyncio
    @patch("jxa_mail_mcp.server.execute_with_core_async")
    async def test_returns_account_list(self, mock_exec):
        ...
        from jxa_mail_mcp.server import list_accounts
...
class TestListMailboxes:
    ...
    async def test_returns_mailbox_list(self, mock_exec):
        ...
        from jxa_mail_mcp.server import list_mailboxes
...
class TestGetEmails:
    ...
    @pytest.mark.asyncio
    @patch("jxa_mail_mcp.server.execute_query_async")
    async def test_filter_all_returns_emails(self, mock_exec):
        ...
        from jxa_mail_mcp.server import get_emails
...
class TestGetEmail:
    ...
    async def test_returns_full_email(self, mock_exec):
        ...
        from jxa_mail_mcp.server import get_email
...
class TestSearch:
    ...
    async def test_uses_fts_when_index_available(self, populated_db):
        ...
        with patch("jxa_mail_mcp.server._get_index_manager") as mock_get:
            mock_get.return_value = mock_manager

            from jxa_mail_mcp.server import search
...
class TestHelperFunctions:
    ...
    def test_resolve_account_returns_provided_account(self):
        ...
        from jxa_mail_mcp.server import _resolve_account
    ...
    def test_resolve_account_returns_none_when_no_default(self):
        ...
        with patch("jxa_mail_mcp.server.get_default_account") as mock:
    ...
    def test_resolve_mailbox_returns_provided_mailbox(self):
        ...
        from jxa_mail_mcp.server import _resolve_mailbox
    ...
    def test_resolve_mailbox_returns_default_when_none(self):
        ...
        with patch("jxa_mail_mcp.server.get_default_mailbox") as mock:
